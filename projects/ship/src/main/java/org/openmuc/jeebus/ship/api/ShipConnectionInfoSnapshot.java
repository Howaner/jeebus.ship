...
/**
 * This class contains information about a SHIP connection.
 * It is used to provide a snapshot of the connection state at a specific point in time, therefore the data can't change.
 */
public class ShipConnectionInfoSnapshot {
	...
	public ShipConnectionInfoSnapshot(ConnectionTypeEnum connectionType, String ski, InetSocketAddress socketAddress,
	 ...
	 *
	 * @return the connection type, either CLIENT_CONNECTION_TO_PEER or PEER_CONNECTED_TO_SERVER
	 */
	...
	/**
	 * Returns the SKI (Subject Key Identifier) of the remote partner.
	 * The SKI is a unique identifier for the public key of the remote partner.
	 *
	 * @return SKI String
	 */
	...
	/**
	 * Returns the trust level that indicates the level of trust in the connection. A value of >=32 means that the user verified the SKI.
	 * It is between {@link ShipNodeParameters#MINIMAL_TRUST_LEVEL 8} and {@link ShipNodeParameters#MAXIMAL_TRUST_LEVEL 96}.
	 *
	...
	/**
	 * Returns true when the connection to a device reached the state "Connection Data
	 * Exchange". This is the State where non-SHIP-specific Messages (i.e. SPINE) are
	 * exchanged.
	 *
	 * @return true if the connection reached the state "Connection Data Exchange", false otherwise
	 */
